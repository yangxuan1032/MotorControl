...
try 
   if(MotorModelType==1)
       save_system('MotorCtrl_DTC_Math.slx');
       close_system('MotorCtrl_DTC_Math.slx');
   else
       save_system('MotorCtrl_DTC_Physic.slx');
       close_system('MotorCtrl_DTC_Physic.slx');
   end
   Simulink.data.dictionary.closeAll;
catch
...
if(MotorModelType==1)
    ...
    saveChanges(DataDic);
    clear
    open_system("MotorCtrl_DTC_Math.slx");
else
    ...
    saveChanges(DataDic);
    clear
    open_system("MotorCtrl_DTC_Physic.slx");
end
