...
try 
   if(MotorModelType==1)
       save_system('MotorCtrl_BLDC_Math.slx');
       close_system('MotorCtrl_BLDC_Math.slx');
   else
       save_system('MotorCtrl_BLDC_Physic.slx');
       close_system('MotorCtrl_BLDC_Physic.slx');
   end
   Simulink.data.dictionary.closeAll;
catch
...
if(MotorModelType==1)
    ...
    saveChanges(DataDic);
    clear
    open_system("MotorCtrl_BLDC_Math.slx");
else
    ...
    saveChanges(DataDic);
    clear
    open_system("MotorCtrl_BLDC_Physic.slx");
end
